...
public class VehicleAssemblerBlock extends HorizontalFacingBlock implements BlockEntityProvider, GenericMotoboxItem {
    ...
    public static final Text INCOMPLETE_VEHICLE_DIALOG = Text.translatable("dialog.motobox.incomplete_vehicle").formatted(Formatting.RED);
    ...
    public VehicleAssemblerBlock(Settings settings) {
        super(settings);
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        if (world.getBlockEntity(pos) instanceof VehicleAssemblerBlockEntity assembler) {
    ...
    public void onStateReplaced(BlockState state, World world, BlockPos pos, BlockState newState, boolean moved) {
        if (!newState.isOf(this) && world.getBlockEntity(pos) instanceof VehicleAssemblerBlockEntity assembler) {
            assembler.dropParts();
        }
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new VehicleAssemblerBlockEntity(pos, state);
    }
}
