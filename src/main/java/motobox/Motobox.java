...
public class Motobox implements ModInitializer {
    ...
    public static final ItemGroup GROUP = FabricItemGroup.builder().displayName(Text.of("motobox")).icon(AUtils::createGroupIcon).entries((enabledFeatures, entries) -> {
    ...
    public static final ItemGroup COURSE_ELEMENTS = FabricItemGroup.builder().displayName(Text.of("motobox_course_elements")).icon(AUtils::createCourseElementsIcon).entries((enabledFeatures, entries) -> {
        for (Item item : Registries.ITEM) {
    ...
    public static final ItemGroup PREFABS = FabricItemGroup.builder().displayName(Text.of("motobox_prefabs")).icon(AUtils::createPrefabsIcon).entries((enabledFeatures, entries) -> {
    ...
    public static final ScreenHandlerType<MechanicTableScreenHandler> MECHANIC_SCREEN =
            Registry.register(Registries.SCREEN_HANDLER, Motobox.id("mechanic_table"), new ScreenHandlerType<MechanicTableScreenHandler>(MechanicTableScreenHandler::new, FeatureSet.empty()));
    public static final ScreenHandlerType<SingleSlotScreenHandler> SINGLE_SLOT_SCREEN =
            Registry.register(Registries.SCREEN_HANDLER, Motobox.id("single_slot"), new ScreenHandlerType<SingleSlotScreenHandler>(SingleSlotScreenHandler::new, FeatureSet.empty()));
