...
public enum AUtils {;
    ...
    public static boolean canMerge(ItemStack a, ItemStack b) {
        return (ItemStack.areItemsEqual(a, b)) && (a.getCount() + b.getCount() <= a.getMaxCount());
    }
    ...
    public static ItemStack createPrefabsIcon() {
        return new VehiclePrefab(Motobox.id("truck"), VehicleFrame.TRUCK, VehicleWheel.SLEEK_RED_OFFROAD, VehicleEngine.DIESEL_FOUR_CYLINDER_ENGINE).toStack();
    }
}
